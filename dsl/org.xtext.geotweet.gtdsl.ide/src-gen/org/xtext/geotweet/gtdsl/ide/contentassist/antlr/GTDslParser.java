		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCountryAccess().getNameAssignment(), "rule__Country__NameAssignment");
					...
					put(grammarAccess.getQueryAccess().getHashtagsAssignment_3(), "rule__Query__HashtagsAssignment_3");
					put(grammarAccess.getQueryAccess().getCountriesAssignment_5(), "rule__Query__CountriesAssignment_5");
				}
			};
		}
